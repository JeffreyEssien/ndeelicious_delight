      ...
      <div className="site-container">
        ...
        {open && (
          <form className="review-form" onSubmit={submit}>
            ...
            <Input label="Review title" required />
            <Textarea label="Your review" rows={4} required />
            <div>
        ...
        <div className="review-grid">
          <article>
            <span>★★★★★</span>
            <h3>Even better than I imagined.</h3>
            <p>Beautiful, balanced and not too sweet. Everyone wanted another slice.</p>
            <small>Amara O. · Verified order</small>
          </article>
          <article>
            <span>★★★★★</span>
            <h3>A new celebration tradition.</h3>
            <p>The whole experience felt thoughtful, from ordering to the final details.</p>
            <small>Dami A. · Verified order</small>
          </article>
          <article>
            <span>★★★★★</span>
            <h3>Genuinely delicious.</h3>
            <p>It looked beautiful, but the flavour is what we’re still talking about.</p>
            <small>Nneka O. · Verified order</small>
          </article>
        </div>
      </div>
    </section>
